...
class SensorEvent {
  ...
  factory SensorEvent.fromMap(Map<String, dynamic> map) {
    return SensorEvent(
      Sensor.fromMap((map['sensor'] as Map).cast<String, Object>()),
      map['accuracy'] as int,
  ...
  factory SensorEvent.fromJson(String source) =>
      SensorEvent.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'SensorEvent(sensor: $sensor, accuracy: $accuracy, timestamp: $timestamp, values: $values)';
  }

  @override
  bool operator ==(covariant SensorEvent other) {
    if (identical(this, other)) return true;

    return other.sensor == sensor &&
